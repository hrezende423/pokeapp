 ...
 *
 * NEW, and not a restyle of the grouped list this replaced. That component (the
 * deleted TypeEffectiveness.tsx) bucketed the matchups into "weak to / resists /
 * immune" and dropped every neutral type, so it answered "what beats this" but
 * could not answer "what does Ice do to it" -- the type simply was not on screen.
 * The grid answers both, and is what the DetailPage frame shows.
 *
 ...
 * from typeEffectivenessAgainst, the same era-resolved function the deleted
 * component read, so the numbers cannot have drifted in the move.
 *
